...
b2Jacobian.prototype = {
    ...
    Compute: function (x1, a1, x2, a2) {
        return (
            this.linear1.x * x1.x + this.linear1.y * x1.y + this.angular1 * a1 + (this.linear2.x * x2.x + this.linear2.y * x2.y) + this.angular2 * a2
        );
    },
    initialize: function () {
...
Object.extend(b2PrismaticJoint.prototype, {
    ...
    GetJointSpeed: function () {
        ...
        var w2 = b2.m_angularVelocity;
        var speed =
            dX * (-w1 * ax1Y) + dY * (w1 * ax1X) + (ax1X * (v2.x + -w2 * r2Y - v1.x - -w1 * r1Y) + ax1Y * (v2.y + w2 * r2X - v1.y - w1 * r1X));
        return speed;
    },
    ...
    PrepareVelocitySolver: function () {
        ...
        if (b2World.s_enableWarmStarting) {
            var P1X =
                this.m_linearImpulse * this.m_linearJacobian.linear1.x + (this.m_motorImpulse + this.m_limitImpulse) * this.m_motorJacobian.linear1.x;
            var P1Y =
                this.m_linearImpulse * this.m_linearJacobian.linear1.y + (this.m_motorImpulse + this.m_limitImpulse) * this.m_motorJacobian.linear1.y;
            var P2X =
                this.m_linearImpulse * this.m_linearJacobian.linear2.x + (this.m_motorImpulse + this.m_limitImpulse) * this.m_motorJacobian.linear2.x;
            var P2Y =
                this.m_linearImpulse * this.m_linearJacobian.linear2.y + (this.m_motorImpulse + this.m_limitImpulse) * this.m_motorJacobian.linear2.y;
            var L1 =
